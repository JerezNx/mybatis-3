...
public class MapperBuilderAssistant extends BaseBuilder {
   ...
   * 复用之前mapper创建的Cache
   *
   * @param namespace 引用的mapper namespace
   */
...
//    创建 Cache
    Cache cache = new CacheBuilder(currentNamespace)
      ...
      .properties(props)
      .build();
//    放到 configuration中,注意 Cache的id是currentNamespace
    configuration.addCache(cache);
//    后面会在 addMappedStatement 方法中,将Cache赋给 MappedStatement
    currentCache = cache;
    return cache;
  }
